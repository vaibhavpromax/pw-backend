...
const dummyData = [
  {
    ...
    requie: [
      ...
      "Good understanding of ReactJs, HTML, SCSS (styling is important),",
      "Javascript Good communication is a must-have for this role",
  ...
  },
  {
    ...
    experience: "Intermediate",
    timing: "full",
    expiry_date: new Date(new Date().getTime() + 10 * 24 * 60 * 60 * 1000),
    date_posted: "2023/06/25 03:06:36",
    skills: [1, 3, 5, 7, 11],
    job_type: "wfh",
    company_status: "IT services",
